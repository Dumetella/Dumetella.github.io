...
export const CoffeeButton = styled.div<CoffeeButtonsProps>`
    width: 25px;
    height: 25px;
    position: absolute;
    top: 25px;
...
export const CoffeeMiddle = styled.div`
    width: 90%;
    height: 160px;
    position: absolute;
    top: 80px;
...
export const CoffeeExit = styled.div`
    width: 60px;
    height: 20px;
    position: absolute;
    top: 0;
...
export const CoffeeArm = styled.div`
    width: 70px;
    height: 20px;
    position: absolute;
    top: 15px;
...
export const CoffeeLiquid = styled.div`
    width: 6px;
    height: 63px;
    opacity: 0;
    position: absolute;
...
export const CoffeeSmokeOne = styled.div<CoffeeSmokeProps>`
    width: 8px;
    height: 20px;
    position: absolute;
    border-radius: 5px;
...
export const CoffeeSmokeTwo = styled.div<CoffeeSmokeProps>`
    width: 8px;
    height: 20px;
    position: absolute;
    border-radius: 5px;
